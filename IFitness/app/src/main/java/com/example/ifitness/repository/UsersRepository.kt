...
class UsersRepository (application: Application) {
    ...
    companion object {
        ...
        const val KEY = "?key=AIzaSyB8Ah97F1FOXLyDSazQAI3w_lh6bQd1IwQ" // pegar nas Configurações do Projeto no Firebase - valor parecido com AIzaSyBxFjit4FD8NN5Mx8hTFQQxeVA1Pv2OUag
